...
export default defineConfig({
  ...
  projects: [
    { name: "desktop-chromium", testMatch: /(sprint[123]|events-first|event-deletion|operations-role|proposal|dashboard-operations)\.spec\.ts/, use: { ...devices["Desktop Chrome"] } },
